 ...
 *				isLess(OurDate): boolean - returns true if current date is less than date provided
 *				isGreater(OurDate): boolean - returns true if current date is greater than date provided
 */
import java.util.*;
